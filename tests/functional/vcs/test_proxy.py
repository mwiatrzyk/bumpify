...
@pytest.fixture
def sut(vcs_reader_writer_mock, console_output_mock):
    return DryRunVcsReaderWriterProxy(vcs_reader_writer_mock, console_output_mock)
...
class TestDryRunVcsReaderWriterProxy:
    ...
    def setup(self, sut: SUT, vcs_reader_writer_mock, console_output_mock):
